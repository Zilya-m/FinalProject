...
class Main(tk.Frame):
    def __init__(self, root):
        ...
        self.view_records()# Показать записи при инициализации

# Инициализация основного окна приложения
    def init_main(self):
        # Создание и расположение панели инструментов
...
# Создание и настройка таблицы (дерева)
...
# Метод для обновления записи
    def update_records(self, name, tel, email):
        ...
        self.db.conn.commit()# Подтверждаем изменения
        self.view_records()# Обновление просмотра записей
# Удаление записи
